...
pub trait send_message {
    ...
    fn send_message(&self, chat: u32, text: String) -> __sdk::Result<()>;
...
impl send_message for super::RemoteReducers {
    fn send_message(&self, chat: u32, text: String) -> __sdk::Result<()> {
        self.imp
            .call_reducer("send_message", SendMessageArgs { chat, text })
    }
    fn on_send_message(
        &self,
        ...
        SendMessageCallbackId(self.imp.on_reducer(
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                let super::ReducerEventContext {
                    event:
                        __sdk::ReducerEvent {
                            reducer: super::Reducer::SendMessage { chat, text },
                            ..
                        },
                    ..
                } = ctx
